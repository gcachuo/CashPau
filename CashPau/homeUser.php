            ...
            <section id="one">
                ...
                <div class="container">
                    <a href="userprofile.php">
                        <img src="images/ussm.png" alt="" width="170" height="170" /></a>
                    <br />
                    <form method="post" action="#">
				        ...
				        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#three">
                            <img src="images/btnpag.png" alt="" width="170" height="170" /></a>
                        <br />
                        <br />
                        <br />
                    </form>
                    ...
                    <form action="home.php" method="post">
                        ...
                        <div class="row uniform">
                            <div class="12u">
                                <ul class="actions">
                                    <li>
                                        <input name="insertservicio" type="submit" class="special" value="Guardar" />
                                    </li>
                                    <li>
